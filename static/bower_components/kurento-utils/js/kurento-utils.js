...
WebRtcPeer.start = function(mode, localVideo, remoteVideo, onSdp, onerror,
	...
	if (wp.mode !== 'recv' && !wp.stream) {
		var constraints = mediaConstraints ? mediaConstraints
				...
				console.log("constraint:"+JSON.stringify(constraints));
...
module.exports = function(input) {
  ...
  console.log("protocol:"+url.slice(0,5));
  if (! protocol) {
    return input;
  }
...
module.exports=[
  "{url:'turn:kurento@54.169.25.40:3478',credential:'kurento',username:'kurento'"
]
